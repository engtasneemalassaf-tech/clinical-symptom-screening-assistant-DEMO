...
## Overview
This project presents a Clinical Symptom Screening Assistant designed to support nurses during early patient screening. The system functions as a **decision-support tool**, not a diagnostic system. Its goal is to help organize patient symptoms, identify potential condition patterns, and highlight cases that require escalation to healthcare professionals.

The project emphasizes safety, clarity, and responsible use of generative AI in a healthcare-related context.
...
4. Model A generates initial hypotheses with confidence indicators  
...
**Edge Case:**  
If red-flag symptoms are detected, the system skips generation and immediately escalates the case.

---

## Architecture Summary
The system follows a modular architecture that separates input handling, reasoning, retrieval, and safety layers. Escalation logic can override model outputs at multiple stages to ensure safe and responsible behavior.
...
## Evaluation
- 15 test cases covering common, ambiguous, and high-risk scenarios  
- Evaluation focused on accuracy, safety behavior, and hallucination detection  

**Observed improvement:**  
Accuracy increased from ~70% to ~85% after prompt refinement and RAG grounding.
...
## Reproducibility
The project is fully reproducible using a Google Colab notebook with documented steps, public datasets, and pinned dependencies.
